chapter \<open>Formalizing System W for Propositional Logic\<close>

theory System_W imports Main begin

text \<open>Wajsberg's Axioms - See page 159 in Alonzo Church (1956): Introduction to Mathematical Logic\<close>
...
abbreviation \<open>Neg p \<equiv> (p \<rightarrow> \<bottom>)\<close>
...
proof -
  obtain r where \<open>\<turnstile> ((r \<rightarrow> p) \<rightarrow> (Neg p \<rightarrow> q))\<close>
